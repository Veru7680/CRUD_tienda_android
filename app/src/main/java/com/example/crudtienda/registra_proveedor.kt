    ...
    private fun ejecutarServicio(URL: String) {
        val stringRequest = object : StringRequest(Method.POST, URL,
            ...
            override fun getParams(): Map<String, String> {
                ...
                parametros["Web"] = edtWeb.text.toString()
                return parametros
            }
        }
